...
[Dacon_Repo/SNP_Classification at main · Byeon-MJ/Dacon_Repo](https://github.com/Byeon-MJ/Dacon_Repo/tree/main/SNP_Classification)
  ...
  Feature Engineerin은 어떻게 진행해야할지 방향을 잡지 못했고 저 점수에서 마무리를 지었다.  지금은 상위권 분들의 코드공유가 올라와서 하나씩 참고하면서 새로이 공부를 하는 중이다.  snp_info.csv를 활용을 해야할것 같은 느낌적인 느낌은 있었는데 정말 잘 활용하셨더라…다양한 기술적인 방법들과 많은 노력들이 눈에 보여서 더 열심히 공부해야겠다고 느꼈다.
